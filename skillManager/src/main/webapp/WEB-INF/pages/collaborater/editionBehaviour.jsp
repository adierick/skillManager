			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="textinput"><spring:message
								code="behaviour.strong_points" /></label>
						<div class="col-sm-4">
							<input class="form-control" name="behaviour.strong_points"
								placeholder="<spring:message code="behaviour.strong_points"/>"
								type="text" required autofocus
								value="${behaviour.behaviour.strong_points}" ${readonly} />
						</div>
						<label class="col-sm-2 control-label" for="textinput"><spring:message
								code="behaviour.areas_improvement" /></label>
						<div class="col-sm-4">
							<input class="form-control" name="behaviour.areas_improvement"
								placeholder="<spring:message code="behaviour.areas_improvement"/>"
								type="text" required autofocus
								value="${behaviour.behaviour.areas_improvement}" ${readonly} />
						</div>
					</div>
